...
<body>
   ...
   <header>
      ...
      <div id="header-sticky" class="header-bottom__area header-bottom__transparent header-sticky-bg-2 header-bottom__bdr z-index-5">
         <div class="container">
            <div class="row g-0 align-items-center">
               <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-6">
                  <div class="header-bottom__logo">
                     <a class="white-logo" href="index.html"><img src="assets/img/logo/logo-white.png" alt=""></a>
                     <a class="black-logo" href="index.html"><img src="assets/img/logo/logo-black.png" alt=""></a>
                  </div>
               </div>
               ...
               <div class="row">
                  <div class="col-xl-8 col-lg-7">
                     <div class="breadcrumb__content z-index-3">
                        <h3 class="breadcrumb__title tp-char-animation">Team Single</h3>
                        <div class="breadcrumb__list wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".4s">
                           ...
                           <span class="child-one"><a href="#">Team Member</a></span>
                           <span class="dvdr"><i class="fal fa-angle-right"></i></span>
                        ...
                        <div class="row">
                           <div class="col-xl-4 col-lg-4 col-md-4">
                              <div class="team-details-img-box text-center">
                                 <div class="team-details-img">
                                    <img src="assets/img/team/team-details-1.jpg" alt="">
                                 </div>
                                 <div class="team-details-work-tag">
                                    <span>
                                       <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M14.9984 7.35929V8.00322C14.9976 9.51254 14.5088 10.9812 13.6051 12.19C12.7014 13.3989 11.4311 14.2832 9.98374 14.7112C8.53635 15.1391 6.98941 15.0877 5.57361 14.5647C4.15782 14.0416 2.94904 13.0749 2.12755 11.8087C1.30605 10.5426 0.915863 9.04474 1.01517 7.53869C1.11448 6.03263 1.69797 4.59903 2.67861 3.45168C3.65925 2.30433 4.9845 1.50472 6.45672 1.17209C7.92893 0.839462 9.46923 0.991643 10.8479 1.60594" stroke="currentcolor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                          <path d="M15.0013 2.40381L8.00211 9.41002L5.90234 7.31025" stroke="currentcolor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                       </svg>
                                    </span>
                                    <span>Looking for Work</span>
                                 </div>
                                 <div class="team-details-work-location">
                                    <span>
                                       <svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M1 6.70031C1 3.55211 3.74226 1 7.125 1C10.5077 1 13.25 3.55211 13.25 6.70031C13.25 9.82383 11.2951 13.4687 8.24506 14.7721C7.53404 15.076 6.71596 15.076 6.00494 14.7721C2.95489 13.4687 1 9.82383 1 6.70031Z" stroke="#5F6168" stroke-width="1.5"/>
                                          <path d="M8.875 7.12524C8.875 8.09174 8.0915 8.87524 7.125 8.87524C6.1585 8.87524 5.375 8.09174 5.375 7.12524C5.375 6.15875 6.1585 5.37524 7.125 5.37524C8.0915 5.37524 8.875 6.15875 8.875 7.12524Z" stroke="#5F6168" stroke-width="1.5"/>
                                       </svg>
                                    </span>
                                    <span>Newark, NJ</span>
                                 </div>
                           ...
                           <div class="col-xl-8 col-lg-8 col-md-8">
                              <div class="team-details-info-box">
                                 <h3 class="team-details-client-title">Imdat Cimsit</h3>
                                 <div class="team-details-contact-box d-flex align-items-center">
                                    ...
                                    <div class="team-details-personal-info">
                                       <a href="#">
                                          <svg width="17" height="13" viewBox="0 0 17 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                             <path d="M1.4668 6.6C1.4668 3.96013 1.4668 2.6402 2.2889 1.8201C3.111 1 4.43415 1 7.08046 1H9.88728C12.5336 1 13.8567 1 14.6788 1.8201C15.5009 2.6402 15.5009 3.96013 15.5009 6.6C15.5009 9.23987 15.5009 10.5598 14.6788 11.3799C13.8567 12.2 12.5336 12.2 9.88728 12.2H7.08045C4.43415 12.2 3.111 12.2 2.2889 11.3799C1.4668 10.5598 1.4668 9.23987 1.4668 6.6Z" stroke="#5F6168" stroke-width="1.5"/>
                                             <path d="M4.27344 3.79999L5.78835 5.05934C7.07713 6.13071 7.72152 6.6664 8.48368 6.6664C9.24584 6.6664 9.89023 6.13071 11.179 5.05934L12.6939 3.79999" stroke="#5F6168" stroke-width="1.5" stroke-linecap="round"/>
                                          </svg>
                                          <span>Message</span>
                                       </a>
                                       <a href="#">
                                          <svg width="13" height="15" viewBox="0 0 13 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                             <path d="M10.1 4.90001C11.1281 4.90001 11.9616 4.02696 11.9616 2.95001C11.9616 1.87305 11.1281 1 10.1 1C9.07178 1 8.23828 1.87305 8.23828 2.95001C8.23828 4.02696 9.07178 4.90001 10.1 4.90001Z" stroke="#5F6168" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                             <path d="M2.65465 9.45012C3.68282 9.45012 4.51632 8.57707 4.51632 7.50012C4.51632 6.42316 3.68282 5.55011 2.65465 5.55011C1.62647 5.55011 0.792969 6.42316 0.792969 7.50012C0.792969 8.57707 1.62647 9.45012 2.65465 9.45012Z" stroke="#5F6168" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                             <path d="M10.1 14C11.1281 14 11.9616 13.1269 11.9616 12.05C11.9616 10.973 11.1281 10.1 10.1 10.1C9.07178 10.1 8.23828 10.973 8.23828 12.05C8.23828 13.1269 9.07178 14 10.1 14Z" stroke="#5F6168" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                             <path d="M4.26172 8.48151L8.50014 11.0685" stroke="#5F6168" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                             <path d="M8.49393 3.93152L4.26172 6.51853" stroke="#5F6168" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                          </svg>
                                          <span>Share</span>
                                       </a>
                                    </div>
                  ...
                  <div class="col-xl-8 col-lg-10">
                     <div class="team-details-text-wrapper pt-80">
                        <div class="team-details-text">
                           <h4 class="team-details-title">About Imdat Cimsit</h4>
                        ...
                        <div class="team-details-feature-list">
                           <ul>
                              ...
                              <li>Pharetra vel turpis nunc eget lorem dolor. Quam vulputate <br>dignissim</li>
                              <li>Vestibulum rhoncus est pellentesque elit ullamcorper dignissim.</li>
                           </ul>
                           <p>Cras sed felis eget velit aliquet. Morbi quis commodo odio aenean sed adipiscing diam donec adipiscing. Nibh tellus molestie nunc non blandit massa enim nec. Ac feugiat sed lectus vestibulum mattis ullamcorper velit. Posuere morbi leo urna molestie.
                           </p>
                        </div>
                     </div>
                  </div>
               ...
               <div class="tp-footer__area p-relative tp-footer__tp-border-bottom">
                  ...
                  <div class="container">
                     <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 pb-30 z-index-3 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".9s">
